...
Java 里的参数传递都是 `call by value` 的，意味着方法里拿到的都是参数值的副本。如果参数值本身是 object reference ，那也是 `call by value`，只是 `object references are passed by value`
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTAwNjI0NzAsLTE2OTUzODE0NjUsLT
g0NjU3OTAwN119
-->